...
$Path = "../../Upload/Tour/Cover/".$NewName;
        ...
        try {
            switch ($ImageType) {
                ...
                case IMAGETYPE_PNG:
                    ...
                    $stmt = $pdo->prepare("INSERT INTO tour(Tour_Key,Title,Detail,Star,City,LocationR,LocationL,Tuor_Images_Cover,Price) 
                    VALUES (:Tour_Key, :Title, :Detail, :Star, :City, :LocationR, :LocationL, :Image, :Price)");
                    $stmt->bindParam(":Tour_Key", $Tour_Key);
