...
$Path = "../../Upload/Hote/Cover/".$NewName;
        ...
        try {
            switch ($ImageType) {
                ...
                case IMAGETYPE_PNG:
                    ...
                    $stmt = $pdo->prepare("INSERT INTO hotel(Hotel_Key,Title,Detail,Star,City,LocationR,LocationL,Image,Price) 
                    VALUES (:Hotel_Key, :Title, :Detail, :Star, :City, :LocationR, :LocationL, :Image, :Price)");
                    $stmt->bindParam(":Hotel_Key", $Hote_Key);
