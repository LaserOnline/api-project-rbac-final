...
$Shopping_Key = $key->generateKey(15);
...
$Path = "../../Upload/Shopping/Cover/".$NewName;
        ...
        try {
            ...
            switch ($ImageType) {
                ...
                case IMAGETYPE_PNG:
                    ...
                    $stmt = $pdo->prepare("INSERT INTO shopping(Shopping_Key,Title,Detail,Star,City,LocationR,LocationL,Shopping_Images_Cover,Price) 
                    VALUES (:Shopping_Key, :Title, :Detail, :Star, :City, :LocationR, :LocationL, :Image, :Price)");
                    $stmt->bindParam(":Shopping_Key", $Shopping_Key);
