...
$Restaurant_Key = $key->generateKey(15);
...
$Path = "../../Upload/Restaurant/Cover/".$NewName;
        ...
        try {
            switch ($ImageType) {
                ...
                case IMAGETYPE_PNG:
                    ...
                    $stmt = $pdo->prepare("INSERT INTO restaurant(Restaurant_Key,Title,Detail,Star,City,LocationR,LocationL,Restaurant_Images_Cover,Price) 
                    VALUES (:Restaurant_Key, :Title, :Detail, :Star, :City, :LocationR, :LocationL, :Image, :Price)");
                    $stmt->bindParam(":Restaurant_Key", $Restaurant_Key);
                    ...
                    $stmt->execute();
                    $res->Message($Restaurant_Key,200);
                    mysqli_close($pdo);
                    break;
                case IMAGETYPE_JPEG:
